...
export const TreasuryView: React.FC<TreasuryViewProps> = ({
  ...
  const netBalance = config.initialBalance + totalRevenues - totalPaidExpenses;
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        {canEdit && (
          <button
            ...
            className="flex items-center justify-center gap-2 px-4 py-2 bg-[#4B5320] hover:bg-[#3d441a] text-white text-xs font-bold uppercase tracking-wider shadow-sm transition-colors"
          >
                        ...
                        >
                          ...
                          <td className="py-3 px-4 text-right whitespace-nowrap">
                            <div className="flex items-center justify-end gap-1.5">
                              ...
                              {canEdit && tx.status !== 'cancelada' && (
                                <button
                                  onClick={() => setTxToCancel(tx)}
                                  className="p-1 rounded hover:bg-rose-950 text-stone-400 hover:text-rose-400"
