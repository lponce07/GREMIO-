  ...
  const content = (
    <div className="flex flex-col h-full bg-[#1A2421] text-white border-r-4 border-[#D4AF37]">
      ...
      <div className="p-4 flex flex-col items-center border-b border-white/10 bg-black/20">
        <div className="w-14 h-14 bg-[#4B5320] border-2 border-[#D4AF37] flex items-center justify-center mb-2 shadow-lg overflow-hidden">
          <MilitaryInsignia className="w-12 h-12" alt="Emblema Oficial da Turma" />
        </div>
