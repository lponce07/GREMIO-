              ...
              >
                ...
                {alert.resolutionNotes && (
                  <div className="p-3 bg-slate-50 border border-slate-200 text-slate-600 text-[11px]">
                    <strong className="text-[#1A2421]">Parecer de Resolução:</strong> {alert.resolutionNotes}{' '}
                    (por{' '}
                    {alert.resolvedBy
                      ? (alert.resolvedBy.startsWith('AL ') || alert.resolvedBy.startsWith('Aluno ')
                          ? alert.resolvedBy
                          : `AL ${alert.resolvedBy}`)
                      : 'Não informado'}{' '}
                    em {formatDatePtBr(alert.resolvedAt)})
                  </div>
                )}
